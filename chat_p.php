            ...
            <div class="community-header-search">
                ...
                <div class="community-right-panels" style="background: url(images/medicn-mark.gif) no-repeat top right;">
                    ...
                    <div class="community-right-panels-inside">
                        ...
                        $sql = "SELECT * FROM medicity.doctorregistration;";
                        $result = $conn->query($sql) or die('Query1 failed: ' . mysqli_error());
                        while ($line = mysqli_fetch_array($result, MYSQL_ASSOC)) {
                            echo '<a href="chat_update.php?id=' . $line["email"] . '">
                            <input type="button" value="' . $line["name"] . '" />
                ...
                <div style="margin:0 auto;width:630px;" >
                    <div class="banner_btm">
                        <div class="care_share">
                            ...
                            <input id="txtname" style="width: 150px" type="text" name="name" maxlength="15" value="<?php
                        echo $_GET["id"];
                        ?>" disabled/>
                    ...
                    <div class="community-right">
                        ...
                        <div id="divPatientsWhoCareLayout">
                            <div class="community-right-panels">
                                <h1>Patients who care</h1>
                                <div class="community-right-panels-inside">
                                    <br />
                                    <br />
                                    Featured Helpful Members<br />
                                </div>
                                <div class="clear2"></div>
                            </div>
                            <br />
