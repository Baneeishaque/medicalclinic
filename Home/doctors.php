...
<div class="layout" style="margin-top: -30px;">
    ...
    <div class="login2">
        <div class="login2-signup">
            ...
            <br />
            <p>
                <a href="../doctorregistration.php" class="blueButtonlogin" style="padding: 10px 20px;text-decoration: none;">Join now
                </a>
                <br />
                <br />
                <br />
        ...
        <div class="login2-login">
            ...
            <form action="" enctype="multipart/form-data" method="post" onsubmit="return validation(this)">
                ...
                <br />
                <input type="submit" formaction="doctor_login_action.php" method="POST" class="redButtonlogin" value="Sign in" onclick="doctorLogin();" style="margin-top: -10px" />
