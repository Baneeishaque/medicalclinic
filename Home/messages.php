...
<html prefix="og:http://ogp.me/ns#" itemscope itemtype="http://schema.org/Product" xmlns="http://www.w3.org/1999/xhtml">
    ...
    <!-- Mirrored from www.icliniccare.com/Home/ConsultDoctor by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 27 Feb 2016 12:32:07 GMT -->
    ...
    <head>
        ...
        <title>Online Medical Prescription, Pharmacy with Doctor Consultation - MEDICAL CLINIC Healthcare</title>
        ...
        <meta name="description" content="Find best online medical consultation, pharmacy with doctor consultation,prescription support, chat, video call facility with doctors/specialists from your home, office or anywhere">
        <meta name="keywords" content="online doctor consultation prescription, online pharmacy with doctor consultation, online medical consultation, online medical consultation, pharmacy with doctor consultation, prescription support">
        <meta name="robot" content="index,follow">
        <meta name="revisit-after" content="7">
        <meta lang="en" content="English" />
        <meta property="OGTitle" content="Consult a Specialist Doctor Online For a Prescription">
        <meta property="OGDescription" content="Consult a specialist doctor online for your health and get your prescription now. Our services are available 24/7 and video call with doctor.">
        <meta property="OGUrl" content="https://www.icliniccare.com/Home/ConsultDoctor">
        ...
        <meta itemprop="description" content="Find best online medical consultation, pharmacy with doctor consultation, prescription support, chat, video call facility with doctors/specialists from your home, office or anywhere." />
    ...
    <div class="layout">
        ...
        <link href="../Content/style_10.css" rel="stylesheet" />
        <link href="../Content/active.css" rel="stylesheet" />
        <link href="../Content/jquery.fancybox.css" rel="stylesheet" />
        <script src="../Scripts/jquery.fancybox.pack.js"></script>
        <link href="../Content/helpers/jquery.fancybox-buttons.css" rel="stylesheet" />
        <script src="../Content/helpers/jquery.fancybox-buttons.js"></script>
        <script src="../Content/helpers/jquery.fancybox-media.js"></script>
        <link href="../Content/helpers/jquery.fancybox-thumbs.css" rel="stylesheet" />
        <script src="../Content/helpers/jquery.fancybox-thumbs.js"></script>
        <script type="text/javascript">
        $(document).ready(function () {
        ...
        <div class="clear"></div>
        <div style="color: black; margin: 0 auto; width: 982px; text-decoration: none !important;"></div>
        <!----BreadCrumb End----->
        ...
        <div style="margin: 0 auto; width: 920px;">
            <!-- pricing table -->
            <div class="p_table" style="margin-top: -12px;">

                <table border="1">
                    <thead>
                        <tr>
                            <th width="20%" style="font-size: 15px;">Email ID</th>
                            <th width="20%" style="font-size: 15px;">Person Name</th>
                            <th width="20%" style="font-size: 15px;">Contact Number</th>
                            <th width="40%" style="font-size: 15px;">Message</th>
                        </tr>
                    </thead>
                    <tbody>
<?php
...
while ($line = mysqli_fetch_array($result, MYSQL_ASSOC)) {
    echo '<tr>
        <td width="20%" style="font-size: 15px;">' . $line["mail"] . '</td>
<td width="20%" style="font-size: 15px;">' . $line["person"] . '</td>
        <td width="20%" style="font-size: 15px;">' . $line["no"] . '</td>
        <td width="40%" style="font-size: 15px;">' . $line["message"] . '</td>
...
?>
        ...
        <script src="../bundles/ConsultDoctorPagebda1?v=Ma2iBQJJ5-Katrm_Xo4TRAKA5JGihok0lBTCHowiIME1"></script>
                    ...
                    <div class="viewport">
                        <ul id="testimonialSlideCarousel" class="overview">
                            ...
                            <li>
                                ...
                                <img src="../images/quote1.jpg" width="22" height="16" alt="" />
                                <p style="width: 300px;">
                                    iClinic is trying best to send specialist care to farthest locations of India.<br />
                                    <br />
                                    <br />
                                    <br />
                            ...
                            <li>
                                ...
                                <img src="../images/quote1.jpg" width="22" height="16" alt="" />
                                <p style="width: 300px;">
                                    I had a wonderful experience at iClinic, where I could get first class consult from a key physician for my ailment.<br />
                                    <br />
                                    <br />
                                    <br />
                            ...
                            <li>
                                ...
                                <img src="../images/quote1.jpg" width="22" height="16" alt="" />
                                <p style="width: 300px;">
                                    I felt the doctor is sitting to me. They way specialist of iClinic asked my problems plus he talked in a very clear way.<br />
                                    <br />
                                    <br />
                                    <br />
    ...
    <div id="footer">
        <div class="layout" align="center" >
            <div class="footerLinks" style="margin-left: 250px;">
                 <a href="../index.html" hreflang="en-us">Home</a> / <a href="../ChatWithDoctor.html" hreflang="en-us">24/7 Online Doctor</a> 
                / <a href=../written-medical-advice.html hreflang="en-us">Written Medical Advice</a>
                <div class="footerLinks2"> <a href="../why-iclinic.html" hreflang="en-us">Why medical clinic</a> | <a href="../patient-forum.html" hreflang="en-us">Patient Forum</a> | <a href="../symptom-checker.html" hreflang="en-us">Symptom Checker</a> | <a href="CoreBenefits.html" hreflang="en-us">Core Benefits</a> | <a href="about-us.html" hreflang="en-us">About Us</a> | <a href="contact-us.html" hreflang="en-us">Contact Us</a>
                    <!-- <a href="#">FAQ's</a>-->
                </div>
            </div>
            <div class="socialMedia">
                <p>Follow us :</p>
                <ul>
                    <li> <a href="https://www.facebook.com/iclinichealthcare" target="_blank" hreflang="en-us" rel="nofollow"> <img src="../images/facebook.jpg" alt="iclinic facebook" /> </a> </li>
                    <li> <a href="https://twitter.com/icliniccare" target="_blank" hreflang="en-us" rel="nofollow"> <img src="../images/twitter.jpg" alt="iclinic twitter" /> </a> </li>
                    <li> <a href="https://plus.google.com/+iclinichpl/posts" target="_blank" hreflang="en-us"> <img src="../images/gplus.jpg" alt="iclinic gplus" /> </a> </li>
                </ul>
            </div>
                    ...
                    <div style="width: 267px; margin-bottom: -15px;">
                        <input id="emailId" name="UserName" type="text" class="input" value="Email Id"
                               onblur="if (this.value == '')
                                           this.value = 'Email Id';checkemail(this.value, 'loadingid', 'messageid');
...
<!-- Mirrored from www.icliniccare.com/Home/ConsultDoctor by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 27 Feb 2016 12:32:09 GMT -->
</html>
