...
<div class="page-heading">
    <h1>Join iClinic Health Care's Doctor Network</h1>
</div>
    ...
    <div class="doctor-joining-form">
        ...
        <table width="800" border="0" cellspacing="0" cellpadding="0" style="margin: 5px auto">
            ...
            <tr>
                ...
                <td class="admin-tbl-data-row-2">
                    <input TabIndex="4" class="txt" data-val="true" data-val-email="The Email field is not a valid e-mail address." data-val-required="The Email field is required." id="Email" name="Email" onblur="checkemail(this.value,&#39;doctorloadingid&#39;,&#39;doctormessageid&#39;);" onkeypress="return ValidateEmail(event)" type="text" value="" />
                    <label>
...
<option value="0">0</option>
            ...
            <tr>
                ...
                <td class="admin-tbl-data-row-2"><input TabIndex="8" class="txt" data-val="true" data-val-length="Your password must be min. 8 characters, should contain alphabet and atleast one special character and one number" data-val-length-max="50" data-val-length-min="5" id="Password" name="Password" type="password" /></td>
                <td class="admin-tbl-data-row-1">Confirm Password<span class="required">*</span></td>
...
<option value="ZW">Zimbabwe</option>
        ...
        <div class="Clr"></div>
        <h2><span>Professional Details</span></h2>
        ...
        <br />
        <div class="one">
            <img src="images/pro-detail-img.jpg" width="179" height="261" />
        </div>

        <table width="800" border="0" cellspacing="0" cellpadding="0" style="margin: 5px auto">
            <tr>
                <td width="140" class="admin-tbl-data-row-1">Hospital<span class="required">*</span></td>
                <td width="240" class="admin-tbl-data-row-2">
                    <input TabIndex="20" class="txt" data-val="true" data-val-required="The Clinic field is required." id="hospital" name="Clinic" onkeypress="return chatAndComment(event)" type="text" value="" />
                </td>
                <td width="140" class="admin-tbl-data-row-1">State/Country</td>
                <td width="240" class="admin-tbl-data-row-2">
                    <select TabIndex="21" class="drp" id="RegistrationCountry" name="RegistrationCountry"><option value="">--Select Country--</option>
<option value="AF">Afghanistan</option>
<option value="AL">Albania</option>
<option value="DZ">Algeria</option>
<option value="AS">American Samoa</option>
...
<option value="ZW">Zimbabwe</option>
            ...
            <tr>
                <td class="admin-tbl-data-row-1">Registration No.<span class="required">*</span></td>
                <td class="admin-tbl-data-row-2"><input TabIndex="22" class="txt" data-val="true" data-val-required="The Registration No. field is required." id="RegistrationNo" name="RegistrationNo" onkeypress="return ValidateAppoinmentCode (event)" type="text" value="" /></td>
                <td class="admin-tbl-data-row-1">Special Interest</td>
                <td class="admin-tbl-data-row-2">
                    <textarea Rows="2" TabIndex="23" class="txtarea" cols="20" id="Interest" name="Interest" onkeypress="return chatAndComment(event)" rows="2">
</textarea>
                </td>
            </tr>
            <tr style="height: 10px;">
            ...
            <tr>
                <td class="admin-tbl-data-row-1">Career Awards</td>
                <td class="admin-tbl-data-row-2">
                    <textarea Rows="2" TabIndex="24" class="txtarea" cols="20" id="Awards" name="Awards" onkeypress="return chatAndComment(event)" rows="2">
</textarea>
                </td>
                <td class="admin-tbl-data-row-1">Achievements</td>
                <td class="admin-tbl-data-row-2"><textarea Rows="2" TabIndex="25" class="txtarea" cols="20" id="Accomplishments" name="Accomplishments" onkeypress="return chatAndComment(event)" rows="2">
</textarea></td>
            </tr>
            <tr style="height: 10px;">
                <td colspan="4"></td>
            ...
            <tr>
                ...
                <td class="admin-tbl-data-row-1" style="vertical-align: top">Doctor Image</td>
        ...
        <div class="five">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="10">
                <tr>
                    ...
                    <td width="92%">
                        ...
                        <br />
                        <a href="Home/Terms-Conditions.html" target="_blank">Read it Here!</a>
                    </td>
                </tr>
            </table>
            <br />
            ...
            <input type="submit" formaction="registration.php" method="POST" id='submitmain' class="button-big" style="cursor: pointer" value="Submit" tabindex="40" />
        </div>
        ...
        <br />
        <br />
  <a href="Home/CoreBenefits.html" hreflang="en-us">Core Benefits</a> | <a href="home/about-us.html" hreflang="en-us">About Us</a> | <a href="home/contact-us.html" hreflang="en-us">Contact Us</a> <!-- <a href="#">FAQ's</a>-->    </div></form><div id="footer"><div class="layout"><div class="footerLinks">
                </div>
